...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { attendance: @concert.attendance, band: @concert.band, date: @concert.date, duration: @concert.duration } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { attendance: @concert.attendance, band: @concert.band, date: @concert.date, duration: @concert.duration } }
