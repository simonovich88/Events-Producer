...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { band_sort: @band.band_sort, debut: @band.debut, members: @band.members, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { band_sort: @band.band_sort, debut: @band.debut, members: @band.members, name: @band.name } }
